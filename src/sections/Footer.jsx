    ...
    <footer className="max-container">
              ...
              <ul>
                {section.links.map((link) => (
                  <li key={link.name} className="mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-slate-gray cursor-pointer">
                    <a href={link.url} className="text-base leading-7 font-montserrat text-white-400">
                      {link.name}
                    </a>
                  </li>
                ))}
      ...
      <div className="flex justify-between text-white-400 mt-12 max-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
          <img src={copyrightSign} alt="copyright sign" width={20} height={20} className="rounded-full m-0"></img>
